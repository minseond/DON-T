...
class FinanceModelArtifact:
    model: Any
    metadata: dict[str, Any]


def save_finance_model_artifact(
    *,
    model: Any,
    output_dir: str | Path,
    schema_version: str,
    ...
    target_name: str,
    model_family: str = "lightgbm_classifier",
    extra_metadata: dict[str, Any] | None = None,
) -> FinanceModelArtifact:
    ...
    return FinanceModelArtifact(model=model, metadata=metadata)


def load_finance_model_artifact(
    ...
    return FinanceModelArtifact(model=model, metadata=metadata_raw)
