...
public enum CommunityErrorCode implements ErrorCode {
    ...
    COHORT_ID_REQUIRED(HttpStatus.BAD_REQUEST, "COMM_400_3", "기수 게시판은 generationNo가 필요합니다."),
    INVALID_CATEGORY_AND_COHORT(
            HttpStatus.BAD_REQUEST, "COMM_400_4", "기수 게시판이 아닌 경우 generationNo를 사용할 수 없습니다."),
    ...
    ALREADY_REACTED(HttpStatus.CONFLICT, "COMM_409_1", "이미 반응한 대상입니다."),
    ...
    SELF_REPORT_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "REPORT_400_1", "본인이 작성한 대상은 신고할 수 없습니다.");
