...
public enum AuthErrorCode implements ErrorCode {
    ...
    EMAIL_NOT_VERIFIED(HttpStatus.BAD_REQUEST, "AUTH_400_2", "이메일 인증이 완료되지 않았습니다."),
    EMAIL_VERIFICATION_CODE_INVALID(HttpStatus.BAD_REQUEST, "AUTH_400_3", "이메일 인증 코드가 올바르지 않습니다."),
    EMAIL_VERIFICATION_CODE_EXPIRED(
            HttpStatus.BAD_REQUEST, "AUTH_400_4", "이메일 인증 코드가 만료되었거나 존재하지 않습니다."),
    PASSWORD_RESET_CODE_INVALID(HttpStatus.BAD_REQUEST, "AUTH_400_5", "비밀번호 재설정 코드가 올바르지 않습니다."),
    PASSWORD_RESET_CODE_EXPIRED(
            HttpStatus.BAD_REQUEST, "AUTH_400_6", "비밀번호 재설정 코드가 만료되었거나 존재하지 않습니다."),
    ...
    EMAIL_VERIFICATION_SEND_LIMIT_EXCEEDED(
            HttpStatus.TOO_MANY_REQUESTS, "AUTH_429_1", "이메일 인증 코드 발송 요청 횟수를 초과했습니다."),
    EMAIL_VERIFICATION_ATTEMPTS_EXCEEDED(
            HttpStatus.TOO_MANY_REQUESTS, "AUTH_429_2", "이메일 인증 시도 횟수를 초과했습니다."),
    PASSWORD_RESET_SEND_LIMIT_EXCEEDED(
            HttpStatus.TOO_MANY_REQUESTS, "AUTH_429_3", "비밀번호 재설정 코드 요청 횟수를 초과했습니다."),
    PASSWORD_RESET_ATTEMPTS_EXCEEDED(
            HttpStatus.TOO_MANY_REQUESTS, "AUTH_429_4", "비밀번호 재설정 인증 시도 횟수를 초과했습니다."),
    EMAIL_DELIVERY_FAILED(HttpStatus.BAD_GATEWAY, "AUTH_502_1", "인증 메일 전송에 실패했습니다.");
